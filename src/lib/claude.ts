...
9. name_figure — Identify a historical figure from a portrait. Provide imageSrc (MUST be one of the bundled assets: "/figures/einstein.jpg", "/figures/newton.jpg", "/figures/tesla.jpg", "/figures/gandhi.jpg"), figure (the person's full name, matching the image), a one-sentence clue describing their contribution without naming them, and exactly 3-4 options that include the correct figure plus plausible same-era distractors. Keep names as written: "Albert Einstein", "Isaac Newton", "Nikola Tesla", "Mahatma Gandhi". Scientists → subject=science, other historical figures (Gandhi, political/cultural leaders) → subject=english. Never invent imageSrc values outside the bundled list.
